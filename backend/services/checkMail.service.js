import { VerifaliaRestClient,BearerAuthenticator } from 'verifalia/node/esm/index.mjs';
...
export const checkEmail = async (email) => {
    ...
    authenticator: new BearerAuthenticator('admin@letshost.dpdns.org', 'QijDEh1TazBsnaB')
});
