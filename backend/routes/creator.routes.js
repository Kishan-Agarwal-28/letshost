...
router.route("/updateDescription").post(logger,verifyJWT,updateCreatorDescription);
router.route("/updateCoverImage").patch(logger,verifyJWT, uploadFile.array("files", 1),updateCreatorCoverImage);
...
router.route("/updateCreatorDetails").post(logger,verifyJWT,updateCreatorDetails);   
