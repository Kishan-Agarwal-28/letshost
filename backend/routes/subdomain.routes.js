...
router
  .route("/update")
  .post(logger, verifyJWT, verifiedMiddleware, updateSubDomain);
router
  .route("/delete")
  .post(logger, verifyJWT, verifiedMiddleware, deleteSubDomain);
router
...
router
  .route("/getuploadsignedurl")
  .post(logger, verifyJWT, verifiedMiddleware, getUploadSignedUrl);
...
router
  .route("/getviewsignedurl")
  .post(logger, verifyJWT, verifiedMiddleware, getViewSignedUrl);
