...
router
  .route("/addToGallery")
  .post(logger, verifyJWT, verifiedMiddleware, addToGallery);
router
  .route("/likeImage")
  .post(logger, verifyJWT, verifiedMiddleware, likeImage);
router
  .route("/saveImage")
  .post(logger, verifyJWT, verifiedMiddleware, saveImage);
router
  .route("/deleteImage")
  .post(logger, verifyJWT, verifiedMiddleware, deleteImage);
router
  .route("/getImagesOfUser")
  .get(logger, verifyJWT, verifiedMiddleware, getImagesOfUser);
...
router
  .route("/downloadImage")
  .post(logger, verifyJWT, verifiedMiddleware, downloadImage);
router
  .route("/getUserImageCount")
  .get(logger, verifyJWT, verifiedMiddleware, getUserImageCount);
router
  .route("/getImagesHistoryOfUser")
  .get(logger, verifyJWT, verifiedMiddleware, getImagesHistoryOfUser);
router
  .route("/getSavedImage")
  .get(logger, verifyJWT, verifiedMiddleware, getSavedImageOfUser);
