...
import { uploadOnCloudinary, deleteOnCloudinary } from "../services/cloudinary.service.js";
...
const registerCreator=asyncHandler(async(req,res)=>{
  try {
      ...
      return res.status(200).json(new apiResponse(200,user,"User successfully registered as Creator"))
  } catch (error) {
...
const updateCreatorFullName=asyncHandler(async(req,res)=>{
    ...
    try{
        ...
        return res.status(200).json(new apiResponse(200,creator,"Creator full name updated successfully"))
    }catch(err){
...
const updateCreatorDescription=asyncHandler(async(req,res)=>{
    ...
    try{
        ...
        await creator.save({validateBeforeSave:false});
        return res.status(200).json(new apiResponse(200,creator,"Creator description updated successfully"))
    }catch(err){
        throw new apiError(500,err.message)
    }
})
...
const updateCreatorLocation=asyncHandler(async(req,res)=>{
    ...
    try{
        ...
        await creator.save({validateBeforeSave:false});
        return res.status(200).json(new apiResponse(200,creator,"Creator location updated successfully"))
    }catch(err){
        throw new apiError(500,err.message)
    }
})
const updateCreatorLinks=asyncHandler(async(req,res)=>{
    ...
    try{
        ...
        creator.links=link
        await creator.save({validateBeforeSave:false});
        return res.status(200).json(new apiResponse(200,creator,"Creator links updated successfully"))
    }catch(err){
        throw new apiError(500,err.message)
    }
})
const updateCreatorDetails = asyncHandler(async (req, res) => {
  try {
    ...
    return res.status(200).json(new apiResponse(200, creator, "Creator details updated successfully"));
  } catch (err) {
    throw new apiError(500, err.message);
  }
});
...
const getCreatorDetails = asyncHandler(async (req, res) => {
  try {
      ...
      return res.status(200).json(new apiResponse(200,creator[0],"Creator details fetched successfully"));
  } catch (error) {
      throw new apiError(500,error.message);
...
const getCreatorStats = asyncHandler(async (req, res) => {
    ...
    throw new apiError(400, "Invalid creator ID");
        ...
        const followersCount = await mongoose.model('subs').countDocuments({ creator: creatorId });
        const followingCount = await mongoose.model('subs').countDocuments({ follower: creatorId });
...
export {registerCreator,updateCreatorFullName,updateCreatorDescription,updateCreatorCoverImage,updateCreatorLocation,updateCreatorLinks,followCreator,getCreatorDetails,getCreatorStats,updateCreatorDetails}