          ...
          <CardContent className="prose prose-gray max-w-none">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-green-50 dark:bg-green-950/50 p-4 rounded-lg border-l-4 border-green-400 dark:border-green-500">
                  ...
                  <p className="text-green-700 dark:text-green-300 mb-0">
                    ...
                    become a "Creator"! This gives you access to our credit
                    system and additional features to enhance your experience.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>
                      Users are prohibited from uploading photographs,
                      hand-drawn artwork, or any non-AI-generated content to the
                ...
                <div>
                  ...
                  <p>
                    ...
                    creations! However, to operate our service effectively,
                    you're giving us permission to display and share your
                    content as part of the LetsHost community experience.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-green-50 dark:bg-green-950/50 p-4 rounded-lg">
                    ...
                    <ul className="space-y-2 text-green-700 dark:text-green-300">
                      <li>
                        ...
                        each AI-generated image you successfully upload and
                        share
                      </li>
                      <li>
                  ...
                  <div className="bg-purple-50 dark:bg-purple-950/50 p-4 rounded-lg">
                    ...
                    <ul className="space-y-2 text-purple-700 dark:text-purple-300">
                      <li>
                        Credits are exclusively used for generating new AI
                ...
                <div className="bg-yellow-50 dark:bg-yellow-950/50 p-4 rounded-lg border-l-4 border-yellow-400 dark:border-yellow-500">
                  ...
                  <p className="text-yellow-700 dark:text-yellow-300 mb-0">
                    If you decide to delete an uploaded image, please note that
                    2 credits will be deducted from your account. This helps us
                    manage platform resources effectively. If your credit
                    balance goes negative, you may temporarily be unable to
                    generate new images until you earn more credits.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-6">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li>
                      Images may be used for both personal and commercial
                      purposes
                    </li>
                    <li>
                ...
                <div className="bg-blue-50 dark:bg-blue-950/50 p-4 rounded-lg">
                  ...
                  <p className="text-blue-700 dark:text-blue-300 mb-0">
                    Our images are free to use for any purpose, and all we ask
                    is that you include a simple credit to LetsHost. This helps
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p>
                    ...
                    you avoid sharing content that could be harmful, offensive,
                    or violate laws. This includes respecting others'
            ...
            <Card className="mb-6">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p>
                    LetsHost and its licensors own all rights, title, and
            ...
            <Card className="mb-6">
              ...
              <CardContent>
                <p>
                  ...
                  to violations of our community guidelines, we'll do our best
                  to communicate with you about the situation and work toward a
            ...
            <div className="bg-primary/10 p-6 rounded-lg text-center">
              <p className="text-lg font-semibold text-primary">
                By using LetsHost, you acknowledge that you have read,
