...
const SEOTool: React.FC = () => {
  ...
  const [structuredDataType, setStructuredDataType] = useState<string>('article');
  ...
  const [formData, setFormData] = useState<SEOFormData>({
    ...
    adsEntries: [{ domain: '', publisherId: '', relationship: 'DIRECT', certificationId: '' }],
  httpHeaders: [
    { name: 'Cache-Control', value: 'max-age=31536000; includeSubDomains' },
    { name: 'Strict-Transport-Security', value: 'max-age=16070400; includeSubDomains' },
    ...
    switch (openGraphType) {
      case 'article':
        tags.push(
          ...
          ...formData.tags.split(',').map(tag => `<meta property="article:tag" content="${tag.trim()}" />`)
        );
        break;
      case 'product':
        tags.push(
  ...
  const generateTwitterCards = () => {
    ...
    switch (twitterCardType) {
      ...
      case 'summary_large_image':
        tags.unshift(`<meta name="twitter:card" content="summary_large_image" />`);
        break;
      case 'app':
        tags.unshift(
...
<link rel="canonical" href="${formData.url}" />`;
  ...
  const generateRobotsTxt = () => {
    ...
    if (formData.disallow) {
      robots += formData.disallow.split('\n').map(d => `Disallow: ${d.trim()}`).join('\n') + '\n';
    }
    
    if (formData.allow) {
      robots += formData.allow.split('\n').map(a => `Allow: ${a.trim()}`).join('\n') + '\n';
    }
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">`;
    ...
    const urls = formData.pages.map(page => `  <url>
    <loc>${page.url}</loc>
...
const generateHttpHeaders = () => {
  ...
  const renderStructuredDataForm = () => (
    <div className="space-y-4">
      <div>
        <Label className="my-2" htmlFor="structured-type">Structured Data Type</Label>
      ...
      {structuredDataType === 'article' && (
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor="title">Article Headline</Label>
          ...
          <div>
            <Label className="my-2" htmlFor="description">Article Description</Label>
            <Textarea
              id="description"
          ...
          <div>
            <Label className="my-2" htmlFor="author">Author Name</Label>
            <Input className="w-full"
              id="author"
          ...
          <div>
            <Label className="my-2" htmlFor="siteName">Publisher/Site Name</Label>
            <Input className="w-full"
              id="siteName"
          ...
          <div>
            <Label className="my-2" htmlFor="image">Featured Image URL</Label>
            <Input className="w-full"
              id="image"
          ...
          <div>
            <Label className="my-2" htmlFor="section">Article Category</Label>
            <Input className="w-full"
              id="section"
          ...
          <div>
            <Label className="my-2" htmlFor="publishedTime">Published Date</Label>
            <SmartDatetimeInput
              id='publishedTime'
              value={new Date(formData.publishedTime)}
              onValueChange={(e) => updateFormData('publishedTime', e?.toISOString()??'')}
              placeholder="e.g. Yesterday 2pm"
            />
          </div>
          <div>
            <Label className="my-2" htmlFor="modifiedTime">Last Modified Date</Label>
            <SmartDatetimeInput
              id='modifiedTime'
              value={new Date(formData.modifiedTime)}
              onValueChange={(e) => updateFormData('modifiedTime', e?.toISOString()??'')}
              placeholder="e.g. Today 9am"
            />
          </div>
          <div className="col-span-1 sm:col-span-2">
            <Label className='my-2' htmlFor='keywords'>Article Keywords (comma-separated)</Label>
            <Textarea
              id='keywords'
              value={formData.tags}
      ...
      {structuredDataType === 'product' && (
        <div className="grid grid-cols-1 md:grid-cols-1  gap-4">
          <div>
            <Label className="my-2" htmlFor="productName">Product Name</Label>
            <Input className="w-full"
              id="productName"
          ...
          <div>
            <Label className="my-2" htmlFor="description">Product Description</Label>
            <Textarea
              id="description"
              value={formData.description}
              onChange={(e) => updateFormData('description', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="brand">Brand Name</Label>
            <Input className="w-full"
              id="brand"
          ...
          <div>
            <Label className="my-2" htmlFor="price">Price (numbers only)</Label>
            <Input className="w-full"
              id="price"
          ...
          <div>
            <Label className="my-2" htmlFor="currency">Currency</Label>
          ...
          <div>
            <Label className="my-2" htmlFor="availability">Availability</Label>
            <Select value={formData.availability} onValueChange={(value) => updateFormData('availability', value as Availability)}>
              <SelectTrigger className='w-full'>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div>
            <Label className="my-2" htmlFor="condition">Product Condition</Label>
            <Select value={formData.condition} onValueChange={(value) => updateFormData('condition', value as Condition)}>
              <SelectTrigger className='w-full'>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="RefurbishedCondition">Refurbished</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div>
            <Label className="my-2" htmlFor="image">Product Image URL</Label>
            <Input className="w-full"
              id="image"
              value={formData.image}
              onChange={(e) => updateFormData('image', e.target.value)}
      ...
      {structuredDataType === 'event' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor="eventName">Event Name</Label>
            <Input className="w-full"
              id="eventName"
          ...
          <div>
            <Label className="my-2" htmlFor="description">Event Description</Label>
            <Textarea
              id="description"
              value={formData.description}
              onChange={(e) => updateFormData('description', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="startDate">Start Date & Time</Label>
            <SmartDatetimeInput
              id='startDate'
              value={new Date(formData.startDate)}
              onValueChange={(e) => updateFormData('startDate', e?.toISOString()??'')}
              placeholder="e.g. Tomorrow 9am"
            />
          </div>
          <div>
            <Label className="my-2" htmlFor="endDate">End Date & Time</Label>
            <SmartDatetimeInput
              id='endDate'
              value={new Date(formData.endDate)}
              onValueChange={(e) => updateFormData('endDate', e?.toISOString()??'')}
              placeholder="e.g. Tomorrow 5pm"
            />
          </div>
          <div>
            <Label className="my-2" htmlFor="location">Event Location</Label>
            <Input className="w-full"
              id="location"
          ...
          <div>
            <Label className="my-2" htmlFor="address">Event Address</Label>
            <Input className="w-full"
              id="address"
          ...
          <div className="col-span-1 sm:col-span-2">
            <Label className="my-2" htmlFor="image">Event Image URL</Label>
            <Input className="w-full"
              id="image"
              value={formData.image}
              onChange={(e) => updateFormData('image', e.target.value)}
      ...
      {structuredDataType === 'localbusiness' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor="businessName">Business Name</Label>
            <Input className="w-full"
              id="businessName"
          ...
          <div>
            <Label className="my-2" htmlFor="description">Business Description</Label>
            <Textarea
              id="description"
              value={formData.description}
              onChange={(e) => updateFormData('description', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="address">Street Address</Label>
            <Input className="w-full"
              id="address"
              value={formData.address}
              onChange={(e) => updateFormData('address', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="openingHours">Opening Hours (comma-separated)</Label>
            <Input className="w-full"
              id="openingHours"
          ...
          <div>
            <Label className="my-2" htmlFor="priceRange">Price Range</Label>
            <Input className="w-full"
              id="priceRange"
          ...
          <div>
            <Label className="my-2" htmlFor="image">Business Image URL</Label>
            <Input className="w-full"
              id="image"
              value={formData.image}
              onChange={(e) => updateFormData('image', e.target.value)}
      ...
      {structuredDataType === 'faq' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <Label className="text-lg font-semibold">FAQ Questions & Answers</Label>
            <Button
              type="button"
          ...
          {formData.questions.map((qa, index) => (
            <div key={index} className="border p-4 rounded-lg space-y-2">
              ...
              <div>
                <Label className="my-2" htmlFor={`question-${index}`}>Question</Label>
                <Input className="w-full"
                  id={`question-${index}`}
                  value={qa.question}
                  onChange={(e) => updateArrayField('questions', index, 'question', e.target.value)}
                  placeholder="What are your business hours?"
                />
              </div>
              <div>
                <Label className="my-2" htmlFor={`answer-${index}`}>Answer</Label>
                <Textarea
                  id={`answer-${index}`}
                  value={qa.answer}
                  onChange={(e) => updateArrayField('questions', index, 'answer', e.target.value)}
      ...
      {structuredDataType === 'howto' && (
        <div className="space-y-4">
          <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
            <div>
              <Label className="my-2" htmlFor="howToName">How-to Title</Label>
              <Input className="w-full"
                id="howToName"
            ...
            <div>
              <Label className="my-2" htmlFor="totalTime">Total Time (ISO 8601 duration)</Label>
              <Input className="w-full"
                id="totalTime"
            ...
            <div>
              <Label className="my-2" htmlFor="image">Guide Image URL</Label>
              <Input className="w-full"
                id="image"
                value={formData.image}
                onChange={(e) => updateFormData('image', e.target.value)}
          ...
          <div className="space-y-4">
            ...
            {formData.steps.map((step, index) => (
              <div key={index} className="border p-4 rounded-lg space-y-2">
                ...
                <div>
                  <Label className="my-2" htmlFor={`step-name-${index}`}>Step Name</Label>
                  <Input className="w-full"
                    id={`step-name-${index}`}
                    value={step.name}
                    onChange={(e) => updateArrayField('steps', index, 'name', e.target.value)}
                    placeholder="Preheat the oven"
                  />
                </div>
                <div>
                  <Label className="my-2" htmlFor={`step-text-${index}`}>Step Instructions</Label>
                  <Textarea
                    id={`step-text-${index}`}
                    value={step.text}
                    onChange={(e) => updateArrayField('steps', index, 'text', e.target.value)}
      ...
      {structuredDataType === 'recipe' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor="recipeName">Recipe Name</Label>
            <Input className="w-full"
              id="recipeName"
          ...
          <div>
            <Label className="my-2" htmlFor="description">Recipe Description</Label>
            <Textarea
              id="description"
              value={formData.description}
              onChange={(e) => updateFormData('description', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="cookTime">Cook Time (ISO 8601)</Label>
            <Input className="w-full"
              id="cookTime"
          ...
          <div>
            <Label className="my-2" htmlFor="prepTime">Prep Time (ISO 8601)</Label>
            <Input className="w-full"
              id="prepTime"
          ...
          <div>
            <Label className="my-2" htmlFor="servings">Number of Servings</Label>
            <Input className="w-full"
              id="servings"
          ...
          <div>
            <Label className="my-2" htmlFor="calories">Calories per Serving</Label>
            <Input className="w-full"
              id="calories"
          ...
          <div>
            <Label className="my-2" htmlFor="image">Recipe Image URL</Label>
            <Input className="w-full"
              id="image"
              value={formData.image}
              onChange={(e) => updateFormData('image', e.target.value)}
          ...
          <div className="col-span-1 sm:col-span-2">
            <Label className="my-2" htmlFor="ingredients">Ingredients (one per line)</Label>
            <Textarea
              id="ingredients"
          ...
          <div className="col-span-1 sm:col-span-2">
            <Label className="my-2" htmlFor="instructions">Instructions (one step per line)</Label>
            <Textarea
              id="instructions"
      ...
      {structuredDataType === 'person' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor="personName">Person Name</Label>
            <Input className="w-full"
              id="personName"
          ...
          <div>
            <Label className="my-2" htmlFor="jobTitle">Job Title</Label>
            <Input className="w-full"
              id="jobTitle"
          ...
          <div>
            <Label className="my-2" htmlFor="company">Company/Organization</Label>
            <Input className="w-full"
              id="company"
          ...
          <div>
            <Label className="my-2" htmlFor="url">Personal Website URL</Label>
            <Input className="w-full"
              id="url"
              value={formData.url}
          ...
          <div className="col-span-1 sm:col-span-2">
            <Label className="my-2" htmlFor="image">Profile Photo URL</Label>
            <Input className="w-full"
              id="image"
              value={formData.image}
              onChange={(e) => updateFormData('image', e.target.value)}
      ...
      {structuredDataType === 'organization' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor="organizationName">Organization Name</Label>
            <Input className="w-full"
              id="organizationName"
          ...
          <div>
            <Label className="my-2" htmlFor="organizationType">Organization Type</Label>
            <Select value={formData.organizationType} onValueChange={(value) => updateFormData('organizationType', value as OrganizationType)}>
              <SelectTrigger className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div>
            <Label className="my-2" htmlFor="description">Organization Description</Label>
            <Textarea
              id="description"
              value={formData.description}
              onChange={(e) => updateFormData('description', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="url">Organization Website</Label>
            <Input className="w-full"
              id="url"
              value={formData.url}
              onChange={(e) => updateFormData('url', e.target.value)}
          ...
          <div className="col-span-1 sm:col-span-2">
            <Label className="my-2" htmlFor="image">Organization Logo URL</Label>
            <Input className="w-full"
              id="image"
              value={formData.image}
              onChange={(e) => updateFormData('image', e.target.value)}
      ...
      {structuredDataType === 'jobposting' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
          ...
          <div>
            <Label className="my-2" htmlFor="hiringOrganization">Hiring Organization</Label>
            <Input className="w-full"
              id="hiringOrganization"
              value={formData.hiringOrganization}
              onChange={(e) => updateFormData('hiringOrganization', e.target.value)}
              placeholder="Tech Innovations LLC"
            />
          </div>
          <div>
            <Label className="my-2" htmlFor="jobLocation">Job Location</Label>
            <Input className="w-full"
              id="jobLocation"
          ...
          <div>
            <Label className="my-2" htmlFor="salary">Salary (annual)</Label>
            <Input className="w-full"
              id="salary"
              value={formData.salary}
          ...
          <div>
            <Label className="my-2" htmlFor="employmentType">Employment Type</Label>
            <Select value={formData.employmentType} onValueChange={(value) => updateFormData('employmentType', value as EmploymentType)}>
              <SelectTrigger className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
      ...
      {structuredDataType === 'video' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor="title">Video Title</Label>
            <Input className="w-full"
              id="title"
              value={formData.title}
              onChange={(e) => updateFormData('title', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="description">Video Description</Label>
            <Textarea
              id="description"
              value={formData.description}
              onChange={(e) => updateFormData('description', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="videoUrl">Video URL</Label>
            <Input className="w-full"
              id="videoUrl"
          ...
          <div>
            <Label className="my-2" htmlFor="duration">Duration (ISO 8601)</Label>
            <Input className="w-full"
              id="duration"
          ...
          <div>
            <Label className="my-2" htmlFor="uploadDate">Upload Date</Label>
            <SmartDatetimeInput
              id='uploadDate'
              value={new Date(formData.uploadDate)}
              onValueChange={(e) => updateFormData('uploadDate', e?.toISOString()??'')}
              placeholder="e.g. Last week"
            />
          </div>
          <div>
            <Label className="my-2" htmlFor="image">Video Thumbnail URL</Label>
            <Input className="w-full"
              id="image"
              value={formData.image}
              onChange={(e) => updateFormData('image', e.target.value)}
      ...
      {structuredDataType === 'website' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor="websiteName">Website Name</Label>
            <Input className="w-full"
              id="websiteName"
          ...
          <div>
            <Label className="my-2" htmlFor="url">Website URL</Label>
            <Input className="w-full"
              id="url"
              value={formData.url}
              onChange={(e) => updateFormData('url', e.target.value)}
      ...
      {structuredDataType === 'breadcrumb' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <Label className="text-lg font-semibold">Breadcrumb Navigation</Label>
            <Button
              type="button"
          ...
          {formData.breadcrumbs.map((breadcrumb, index) => (
            <div key={index} className="border p-4 rounded-lg space-y-2">
              ...
              <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
                <div>
                  <Label className="my-2" htmlFor={`breadcrumb-name-${index}`}>Page Name</Label>
                  <Input className="w-full"
                    id={`breadcrumb-name-${index}`}
                    value={breadcrumb.name}
                    onChange={(e) => updateArrayField('breadcrumbs', index, 'name', e.target.value)}
                    placeholder="Home, Products, Category, etc."
                  />
                </div>
                <div>
                  <Label className="my-2" htmlFor={`breadcrumb-url-${index}`}>Page URL</Label>
                  <Input className="w-full"
                    id={`breadcrumb-url-${index}`}
                    value={breadcrumb.url}
                    onChange={(e) => updateArrayField('breadcrumbs', index, 'url', e.target.value)}
  ...
  const renderOpenGraphForm = () => (
    <div className="space-y-4">
      <div>
        <Label className="my-2" htmlFor="og-type">Open Graph Type</Label>
      ...
      <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
        ...
        <div>
          <Label className="my-2" htmlFor="url">URL</Label>
          <Input className="w-full"
            id="url"
            value={formData.url}
            onChange={(e) => updateFormData('url', e.target.value)}
        ...
        <div>
          <Label className="my-2" htmlFor="image">Image URL</Label>
          <Input className="w-full"
            id="image"
            value={formData.image}
            onChange={(e) => updateFormData('image', e.target.value)}
        ...
        <div>
          <Label className="my-2" htmlFor="siteName">Site Name</Label>
          <Input className="w-full"
            id="siteName"
            value={formData.siteName}
            onChange={(e) => updateFormData('siteName', e.target.value)}
        ...
        <div>
          <Label className="my-2" htmlFor="locale">Locale</Label>
          <Input className="w-full"
            id="locale"
      ...
      {openGraphType === 'article' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4 border-t pt-4">
          ...
          <div>
            <Label className="my-2" htmlFor="section">Section</Label>
            <Input className="w-full"
              id="section"
              value={formData.section}
              onChange={(e) => updateFormData('section', e.target.value)}
          ...
          <div>
            <Label className="my-2" htmlFor="publishedTime">Published Time</Label>
            <SmartDatetimeInput
              id='publishedTime'
              value={new Date(formData.publishedTime)}
              onValueChange={(e) => updateFormData('publishedTime', e?.toISOString()??'')}
          ...
          <div>
            <Label className="my-2" htmlFor="modifiedTime">Modified Time</Label>
            <SmartDatetimeInput
              id='modifiedTime'
              value={new Date(formData.modifiedTime)}
              onValueChange={(e) => updateFormData('modifiedTime', e?.toISOString()??'')}
          ...
          <div className="col-span-1 sm:col-span-2">
            <Label className="my-2" htmlFor="tags">Tags (comma-separated)</Label>
            <Input className="w-full"
              id="tags"
              value={formData.tags}
              onChange={(e) => updateFormData('tags', e.target.value)}
      ...
      {openGraphType === 'product' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t pt-4">
          ...
          <div>
            <Label className="my-2" htmlFor="condition">Condition</Label>
            <Select value={formData.condition} onValueChange={(value) => updateFormData('condition', value as Condition)}>
              <SelectTrigger className="w-full">
                <SelectValue />
              </SelectTrigger>
      ...
      {openGraphType === 'video' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4 border-t pt-4">
          ...
          <div>
            <Label className="my-2" htmlFor="duration">Duration (seconds)</Label>
            <Input className="w-full"
              id="duration"
              value={formData.duration}
              onChange={(e) => updateFormData('duration', e.target.value)}
  ...
  const renderTwitterCardsForm = () => (
    <div className="space-y-4">
      <div>
        <Label className="my-2" htmlFor="twitter-type">Twitter Card Type</Label>
      ...
      {twitterCardType === 'player' && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4 border-t pt-4">
          <div>
            <Label className="my-2" htmlFor="videoUrl">Player URL</Label>
            <Input className="w-full"
              id="videoUrl"
              value={formData.videoUrl}
              onChange={(e) => updateFormData('videoUrl', e.target.value)}
  ...
  const renderMetaTagsForm = () => (
    <div className="grid grid-cols-1 sm:grid-cols-1  md:grid-cols-2 gap-4">
      <div>
        <Label className="my-2" htmlFor="title">Page Title</Label>
        <Input className="w-full"
          id="title"
          value={formData.title}
          onChange={(e) => updateFormData('title', e.target.value)}
      ...
      <div>
        <Label className="my-2" htmlFor="description">Meta Description</Label>
        <Textarea
          id="description"
          value={formData.description}
          onChange={(e) => updateFormData('description', e.target.value)}
      ...
      <div>
        <Label className="my-2" htmlFor="tags">Keywords</Label>
        <Input className="w-full"
          id="tags"
          value={formData.tags}
          onChange={(e) => updateFormData('tags', e.target.value)}
      ...
      <div className="col-span-1 sm:col-span-2">
        <Label className="my-2" htmlFor="url">Canonical URL</Label>
        <Input className="w-full"
          id="url"
          value={formData.url}
          onChange={(e) => updateFormData('url', e.target.value)}
  ...
  const renderRobotsForm = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
        <div>
          <Label className="my-2" htmlFor="userAgent">User Agent</Label>
          <Input className="w-full"
            id="userAgent"
        ...
        <div>
          <Label className="my-2" htmlFor="crawlDelay">Crawl Delay (seconds)</Label>
          <Input className="w-full"
            id="crawlDelay"
      ...
      <div>
        <Label className="my-2" htmlFor="disallow">Disallow Paths (one per line)</Label>
        <Textarea
          id="disallow"
      ...
      <div>
        <Label className="my-2" htmlFor="allow">Allow Paths (one per line)</Label>
        <Textarea
          id="allow"
      ...
      <div>
        <Label className="my-2" htmlFor="sitemapUrl">Sitemap URL</Label>
        <Input className="w-full"
          id="sitemapUrl"
  ...
  const renderSitemapForm = () => (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button
          type="button"
          onClick={() => addArrayItem('pages', { url: '', lastmod: new Date().toISOString().split('T')[0], changefreq: 'weekly', priority: '0.8' })}
          size="sm"
        >
          Add Page
        </Button>
      ...
      {formData.pages.map((page, index) => (
        <div key={index} className="border p-4 rounded-lg space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1  md:grid-cols-2 gap-4">
            <div>
              <Label className="my-2" htmlFor={`page-url-${index}`}>Page URL</Label>
              <Input className="w-full"
                id={`page-url-${index}`}
                value={page.url}
                onChange={(e) => updateArrayField('pages', index, 'url', e.target.value)}
                placeholder="https://example.com/page"
              />
            </div>
            <div>
              <Label className="my-2" htmlFor={`page-lastmod-${index}`}>Last Modified</Label>
              <Input className="w-full"
                id={`page-lastmod-${index}`}
                type="date"
                value={page.lastmod}
                onChange={(e) => updateArrayField('pages', index, 'lastmod', e.target.value)}
              />
            </div>
            <div>
              <Label className="my-2" htmlFor={`page-changefreq-${index}`}>Change Frequency</Label>
              <Select 
                value={page.changefreq} 
                onValueChange={(value) => updateArrayField('pages', index, 'changefreq', value as ChangeFreq)}
              >
                <SelectTrigger className="w-full">
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              <Label className="my-2" htmlFor={`page-priority-${index}`}>Priority (0.0 - 1.0)</Label>
              <Input className="w-full"
                id={`page-priority-${index}`}
                value={page.priority}
                onChange={(e) => updateArrayField('pages', index, 'priority', e.target.value)}
                placeholder="0.8"
                min="0"
                max="1"
                step="0.1"
  ...
  <div className="space-y-4">
    <div className="bg-blue-50 p-4 rounded-lg">
      ...
      <p className="text-blue-800 text-sm">
        Ads.txt helps fight ad fraud by allowing publishers to declare which companies are authorized to sell their inventory.
        Place this file at the root of your domain (e.g., https://example.com/ads.txt).
      </p>
    </div>
    ...
    <div className="flex items-center justify-between">
      ...
      <Button
        type="button"
        onClick={() => addArrayItem('adsEntries', { domain: '', publisherId: '', relationship: 'DIRECT', certificationId: '' })}
        size="sm"
      >
        Add Entry
      </Button>
    ...
    {formData.adsEntries.map((entry, index) => (
      <div key={index} className="border p-4 rounded-lg space-y-2">
        ...
        <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
          <div>
            <Label className="my-2" htmlFor={`ads-domain-${index}`}>Domain</Label>
            <Input className="w-full"
              id={`ads-domain-${index}`}
              value={entry.domain}
              onChange={(e) => updateArrayField('adsEntries', index, 'domain', e.target.value)}
              placeholder="google.com, facebook.com, etc."
            />
          </div>
          <div>
            <Label className="my-2" htmlFor={`ads-publisher-${index}`}>Publisher ID</Label>
            <Input className="w-full"
              id={`ads-publisher-${index}`}
              value={entry.publisherId}
              onChange={(e) => updateArrayField('adsEntries', index, 'publisherId', e.target.value)}
              placeholder="pub-0000000000000000"
            />
          </div>
          <div>
            <Label className="my-2" htmlFor={`ads-relationship-${index}`}>Relationship</Label>
            <Select 
              value={entry.relationship} 
              onValueChange={(value) => updateArrayField('adsEntries', index, 'relationship', value as 'DIRECT' | 'RESELLER')}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            <Label className="my-2" htmlFor={`ads-cert-${index}`}>Certification Authority ID (optional)</Label>
            <Input className="w-full"
              id={`ads-cert-${index}`}
              value={entry.certificationId}
              onChange={(e) => updateArrayField('adsEntries', index, 'certificationId', e.target.value)}
    ...
    <div className="bg-yellow-50 p-4 rounded-lg">
      <h4 className="font-semibold text-yellow-900 mb-2">Common Ad Networks</h4>
      <div className="text-yellow-800 text-sm space-y-1">
        <p><strong>Google AdSense:</strong> google.com, pub-XXXXXXXXXXXXXXXX, DIRECT, f08c47fec0942fa0</p>
        <p><strong>Facebook Audience Network:</strong> facebook.com, XXXXXXXXXXXXXXXX, DIRECT, c3e20eee3f780d68</p>
        <p><strong>Amazon Publisher Services:</strong> amazon-adsystem.com, XXXX, DIRECT</p>
      </div>
    </div>
  </div>
);
...
const renderHeadersForm = () => (
  <div className="space-y-4">
    <div className="bg-green-50 p-4 rounded-lg">
      <h3 className="font-semibold text-green-900 mb-2">HTTP Security Headers</h3>
      <p className="text-green-800 text-sm">
        Security headers help protect your website from various attacks. Configure these headers in your web server or through your hosting provider.
      </p>
    </div>
  ...
  >
    Remove
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <Label className="my-2" htmlFor={`header-name-${index}`}>Header Name</Label>
            <Select
              value={header.name}
              onValueChange={(value) => {
                const defaultValue = securityHeaders[value as SecurityHeaderName] || '';
                updateArrayField('httpHeaders', index, 'name', value);
                if (!header.value) {
                  updateArrayField('httpHeaders', index, 'value', defaultValue);
                }
              }}
            >
              <SelectTrigger>
          ...
          <div className="col-span-1 sm:col-span-2">
            <Label className="my-2" htmlFor={`header-value-${index}`}>Header Value</Label>
            <Input className="w-full"
              id={`header-value-${index}`}
              value={securityHeaders[header.name as SecurityHeaderName] ?? ''}
              onChange={(e) => updateArrayField('httpHeaders', index, 'value', e.target.value)}
        ...
        {header.name === 'Cache-Control' && (
          <HelpText
            label="Cache-Control"
            examples={["no-store", "no-cache", "must-revalidate", "max-age=31536000"]}
        ...
        {header.name === 'Referrer-Policy' && (
          <HelpText
            ...
            examples={["no-referrer", "origin", "strict-origin-when-cross-origin", "unsafe-url"]}
        ...
        {header.name === 'Content-Security-Policy' && (
          <HelpText
            ...
            examples={["default-src 'self'", "script-src 'self' 'unsafe-inline'", "style-src 'self'"]}
    ...
    <div className="bg-blue-50 p-4 rounded-lg">
      <h4 className="font-semibold text-blue-900 mb-2">Security Header Recommendations</h4>
      <div className="text-blue-800 text-sm space-y-2">
        <p><strong>Strict-Transport-Security:</strong> Forces HTTPS connections</p>
        <p><strong>X-Frame-Options:</strong> Prevents clickjacking attacks</p>
        <p><strong>X-Content-Type-Options:</strong> Prevents MIME type sniffing</p>
        <p><strong>Content-Security-Policy:</strong> Prevents XSS and data injection attacks</p>
        <p><strong>Referrer-Policy:</strong> Controls referrer information sent to other sites</p>
        <p><strong>Permissions-Policy:</strong> Controls browser feature access (camera, location, etc.)</p>
        <p><strong>COEP/COOP/CORP:</strong> Strengthen isolation boundaries for cross-origin security</p>
      </div>
    </div>
  </div>
);
      ...
      <div className="container mx-auto px-2 py-4 md:px-4 md:py-6 lg:px-6 xl:max-w-6xl">
        <Card className="overflow-hidden shadow-lg">
          <CardHeader className="p-4 md:p-6 space-y-2">
            <CardTitle className="text-xl md:text-2xl">SEO Code Generator</CardTitle>
            <CardDescription className="text-sm md:text-base">
              Generate structured data, meta tags, Open Graph, Twitter Cards, robots.txt, and sitemaps for your website
            </CardDescription>
          </CardHeader>
        <CardContent className="p-2 sm:p-4 md:p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
            <TabsList className="grid w-full grid-cols-1 sm:grid-cols-1  md:grid-cols-2  lg:grid-cols-8 gap-1 sm:gap-2 grid-rows-8 sm:grid-rows-2 md:grid-rows-1 h-max">
              <TabsTrigger className="text-xs sm:text-sm" value="structured-data">Structured Data</TabsTrigger>
              <TabsTrigger className="text-xs sm:text-sm" value="open-graph">Open Graph</TabsTrigger>
              <TabsTrigger className="text-xs sm:text-sm" value="twitter-cards">Twitter Cards</TabsTrigger>
              <TabsTrigger className="text-xs sm:text-sm" value="meta-tags">Meta Tags</TabsTrigger>
              <TabsTrigger className="text-xs sm:text-sm" value="robots">Robots.txt</TabsTrigger>
              <TabsTrigger className="text-xs sm:text-sm" value="sitemap">Sitemap</TabsTrigger>
              <TabsTrigger className="text-xs sm:text-sm" value="ads">Ads.txt</TabsTrigger>
              <TabsTrigger className="text-xs sm:text-sm" value="headers">Security Headers</TabsTrigger>
            </TabsList>
        ...
        <Card className="mt-6 shadow-lg">
          ...
          <CardContent>
            <pre className="p-2 md:p-4 rounded-lg overflow-x-auto overflow-y-auto max-h-[60vh] text-xs md:text-sm bg-muted">
              <code className="block whitespace-pre-wrap">{generatedCode}</code>
            </pre>
          </CardContent>
        </Card>
      )}
