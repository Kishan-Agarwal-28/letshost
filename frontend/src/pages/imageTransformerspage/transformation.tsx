      ...
      if (templates.length === 0) {
        ...
        if (template) {
          ...
          toast({
            ...
            description:
              "Template deleted successfully from your local storage",
            duration: 3000,
            variant: "success",
          });
        } else {
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center justify-between">
                    <span className="text-lg">Image Controls</span>
                    <Dialog>
                      <DialogTrigger>
                        <Button
                          size="sm"
                      ...
                      <DialogContent>
                        ...
                        <Form {...templateForm}>
                          ...
                          >
                            ...
                            <DialogFooter>
                              <DialogClose>
                                <span onClick={() => templateForm.reset()}>
                                  Cancel
                                </span>
                              </DialogClose>
                  ...
                  <Tabs defaultValue="resize" className="w-full">
                    ...
                    <TabsContent value="transform" className="space-y-4">
                      ...
                      <div className="flex gap-2">
                        <Button
                          variant={
                            options.rotation.flip ? "default" : "outline"
                          }
                          size="sm"
                          onClick={() =>
                            updateOptions(
                        ...
                        <Button
                          variant={
                            options.rotation.flop ? "default" : "outline"
                          }
                          size="sm"
                          onClick={() =>
                            updateOptions(
