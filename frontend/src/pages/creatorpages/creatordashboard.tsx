  ...
  useEffect(() => {
    if (getCreatorStats.isSuccess && getCreatorStats.data) {
      ...
      setEditableData({
        ...
        description:
          getCreatorStats.data.data.data.creatorInfo.description ?? "",
      ...
      if (
        ...
        getCreatorStats.data.data.data.creatorInfo._id !== creatorId
      ) {
        navigate("/");
      }
    }
          ...
          <div className="relative flex-shrink-0">
            <Avatar className="w-32 h-32 md:w-40 md:h-40 border-4 border-white shadow-2xl">
              ...
              <AvatarFallback className="text-3xl bg-gradient-to-br from-blue-500 to-purple-600 text-white">
                {analytics?.creatorInfo.fullName
                  ?.split(" ")
                  .map((n) => n[0])
                  .join("")}
              </AvatarFallback>
              ...
              <TooltipTrigger className="text-[14px] leading-[1.4] antialiased font-sans box-border absolute right-0 bottom-0">
                <div className="text-[14px] leading-[1.4] antialiased w-[40px] h-[40px] box-border font-sans">
                  <svg
                    ...
                    width="24"
                    height="24"
                    className="text-[14px] leading-[1.4] antialiased font-sans box-border m-0 absolute top-0 left-0 w-full h-full fill-[#54ca84]"
                  >
          ...
          <div className="flex items-center gap-1 overflow-x-auto">
            {[
              { id: "overview", label: "Overview", icon: BarChart3 },
              {
                ...
                label: "Gallery",
                icon: Grid,
                count: analytics?.overview.totalImages,
              },
              ...
              <div>
                ...
                <p className="text-3xl font-bold mt-1">
                  {formatNumber(
                    Number(
                      (
                        ((analytics?.overview.avgLikesPerImage ?? 0) +
              ...
              <PieChart>
                <Pie
                  data={[
                    ...
                    {
                      name: "Saves",
                      value: analytics?.overview.totalSaves,
                      color: "#f59e0b",
                    },
                  ]}
                  cx="50%"
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold">
                  {analytics?.recentActivity.recentImages}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Likes Received</span>
                <span className="font-semibold">
                  {analytics?.recentActivity.recentLikes}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Downloads</span>
                <span className="font-semibold">
                  {analytics?.recentActivity.recentDownloads}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Saves</span>
                <span className="font-semibold">
                  {analytics?.recentActivity.recentSaves}
                </span>
              </div>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium">
                    {analytics?.overview.avgLikesPerImage.toFixed(2)}
                  </span>
                </div>
                <Progress
                  value={
                    ((analytics?.overview.avgLikesPerImage ?? 0) / 100) * 100
                  }
                  color="#4e80ee"
                />
              </div>
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium">
                    {analytics?.overview.avgDownloadsPerImage.toFixed(2)}
                  </span>
                </div>

                <Progress
                  value={
                    ((analytics?.overview.avgDownloadsPerImage ?? 0) / 100) *
                    100
                  }
                  color="#55b685"
                />
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium">
                    {analytics?.overview.avgSavesPerImage.toFixed(2)}
                  </span>
                </div>

                <Progress
                  value={
                    ((analytics?.overview.avgSavesPerImage ?? 0) / 50) * 100
                  }
                  color="#e9a23b"
                />
              </div>
