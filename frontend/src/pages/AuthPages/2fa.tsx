...
function TwoFA() {
  ...
  if (
    ...
    searchParams.get("action") === "enable"
  ) {
    return (
      <>
        <div className="flex justify-center items-center h-dvh w-full relative text-white overflow-hidden p-4 md:p-8">
          <div className="bg-black rounded-2xl w-[90%] md:w-[400px] min-h-[400px] flex flex-col justify-center items-center shadow-2xl p-6 sm:p-8">
            ...
            <p className="text-sm text-muted-foreground text-center mb-8">
              Please authenticate with your security key to register your
              passkey.
            </p>
      ...
      <>
        <div className="flex justify-center items-center h-dvh w-full relative text-white overflow-hidden p-4 md:p-8">
          <div className="bg-black rounded-2xl w-[90%] md:w-[400px] min-h-[400px] flex flex-col justify-center items-center shadow-2xl p-6 sm:p-8">
            ...
            <p className="text-sm text-muted-foreground text-center mb-8">
              Two factor authentication is currently enabled. It is recommended
              to disable it only if you are sure you want to remove this extra
              layer of security. You can re-enable it later.
            </p>
            <Button
