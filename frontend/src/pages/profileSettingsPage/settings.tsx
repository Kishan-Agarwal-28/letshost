  ...
  const handleProviderConnect = async () => {
    ...
    if (data.isSuccess) {
      toast({
        title: "Success",
        description:
          "You have successfully logged out Please login with provider to connect",
        variant: "success",
        duration: 5000,
      });
      userStore.deleteUser();
            ...
            <Card className="border-0 shadow-lg bg-card backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center gap-6">
                    ...
                    <Dialog>
                      <DialogTrigger className="cursor-pointer">
                        <AvatarCircles
                          ...
                          className="h-24 w-24 border-4 flex items-center justify-center rounded-2xl shadow-lg"
                        />
                      </DialogTrigger>
                      <DialogContent>
                        <img
                  ...
                  <div className="space-y-1 flex w-full items-center justify-around gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        className="text-slate-400 bg-background px-4 py-1"
                        variant={"secondary"}
                      >
                        {user?.tier}
                      </Badge>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-white/50 dark:bg-slate-700/50"
                      disabled={
                        searchParams.get("token")?.toString() ? false : true
                      }
                    />
                    <Button
                      variant={"ghost"}
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-gray-600 to-zinc-600 hover:from-zinc-700 hover:to-gray-700"
                ...
                {showPasswordForm ? (
                  ...
                  <div className="relative h-[300px] flex items-center justify-center rounded-md overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black/20 backdrop-blur-sm z-10 flex flex-col items-center justify-center text-center p-6">
                      ...
                      <Button
                        variant="outline"
                        onClick={handlePasswordChangeRequestEmail}
                        className="w-full flex"
                        disabled={RequestPasswordChangeEmail.isPending}
                      >
                        Request Email
                      </Button>
                    </div>
