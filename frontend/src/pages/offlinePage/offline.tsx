...
const NotchTailLeft = () => (
  ...
  >
    <defs>
      <mask id="notch_mask_left" maskUnits="userSpaceOnUse" x="0" y="0" width="60" height="42">
        <rect fill="white" width="60" height="42" />
        <path d="M1 1L8.0783 1C15.772 1 22.7836 5.41324 26.111 12.3501L34.8889 30.6498C38.2164 37.5868 45.228 42 52.9217 42H59V1H1Z" fill="black" />
      </mask>
    </defs>
...
const NotchTailRight = () => (
  ...
  >
    <defs>
      <mask id="notch_mask_right" maskUnits="userSpaceOnUse" x="0" y="0" width="60" height="42">
        <rect fill="white" width="60" height="42" />
        <path d="M59 1L51.9217 1C44.228 1 37.2164 5.41324 33.8889 12.3501L25.111 30.6498C21.7836 37.5868 14.772 42 7.0783 42H1V1H59Z" fill="black" />
      </mask>
    </defs>
    <rect width="60" height="42" fill="#000" />
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-black text-white font-['Inter'] overflow-hidden p-2.5">
      <motion.div 
        ...
        style={{
          boxShadow: '0 20px 40px rgba(22, 22, 22, 0.6), 0 0 30px rgba(0, 0, 0, 0.3), 0 0 2px rgba(42, 41, 41, 0.05)'
        }}
            ...
            >
              ...
              >
                ...
                <p className="m-0 text-[#ccc] flex-1 text-base leading-6">
                  You are currently offline. Please check your internet connection and try again.
                  Till then you can try the game we made for you in such cases 😉
                </p>
              </motion.div>
            </motion.div>
          </div>
